...
function detectCollision(tar)
    return ball.x > tar.x and tar.x + 7 > ball.x and ball.y > tar.y and tar.y + tar.h + 3 > ball.y
end
...
function love.draw()
    ...
    if game.init then
        ...
        love.graphics.printf(message, fontSq, winX * 0.04, winY / 2 - fontSq:getHeight(gameStartFormatMessage),
            winX * 0.9, "center")
    end
